        ...
        <div class="card-body">
          <form method="POST" action="doctorregister.php">
            ...
            <div class="form-group">
              ...
              <input type="name" class="form-control" aria-describedby="emailHelp" placeholder="Enter specialization" name="spec">
            </div>
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
          ...
          <div class="text-center">
            <a class="d-block small mt-3" href="doctorlogin.php">Login Page</a>
...
function NewUser($con){
  ...
  $pass = $_POST['pass'];
  $cpass = $_POST['cpass'];
  $query = "INSERT INTO doctor (fname,lname,email,spec,pass,cpass) VALUES ('$fname','$lname','$email','$spec','$pass','$cpass')";
  ...
  if ($data==true) {
    ...
    // }
  if ($pass!=$cpass) {
    $query= "UPDATE doctor SET pass ='$cpass' WHERE email='$email' ";
    //echo $query;
    $data = mysqli_query($con,$query) or die (mysqli_error($con));
    if ($data) {
...
function Signup($con){
  ...
  {
    //echo "signup";
    $query = mysqli_query($con,"SELECT * FROM doctor WHERE email ='$_POST[email]' AND pass = '$_POST[pass]'")or die (mysqli_error($con));
