...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg  fixed-top" id="mainNav" style="background-color: #003366 ; color: white">
      <a class="navbar-brand" href="main.html" style="color:white;">PATIENT LIST</a>
...
<div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <?php
require('config.php');
$query = "SELECT fname,lname, email, adhar from patient";
$response = mysqli_query($con,$query);
if ($response) {
  echo "<table colspan='2' style='border:2px'>

  <tr><td colspan='2'><u>FIRST NAME</u> </td>
  <td colspan='2'>________________________</td>

  <td colspan='2'> <u>LAST NAME</u> </td>
  <td colspan='2'>________________________</td>

  <td colspan='2'><u> EMAIL</u> </td>
  <td colspan='2'>________________________</td>

  <td colspan='2'><u> PHONE</u> </td>
  <td colspan='2'>________________________</td>
  ...
  while($row=mysqli_fetch_array($response))
  {
    ...
    <td colspan='2'>".$row['fname']."</td>
    <td colspan='2'>
 </td>
        <td colspan='2'>".$row['lname']."</td>
<td colspan='2'></td>
    ...
    <td colspan='2'>".$row['adhar']."</td>
    <td colspan='2'>
 </td>
 <td><form action='patients_list.php' method='POST'><input type='file' name='file'><input type='submit' name='submit' value='submit'></form></td>
</tr>
    ";
  }
  //echo "";
...
<!-- 
              <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                ...
                <tbody>
                  <tr>
                  <td><a href="abc.pdf">Tiger Nixon</a></td>
                    
                    <td>System Architect</td>
                    <td>Edinburgh</td>
                    <td>61</td>
                    <td><a href="abc.pdf">report</a><br><a href="abcd.pdf">prescription</a><br><a href="abc.docx">prescriptio</a></td>
...
//   <tr><td><u> FIRST NAME</u> </td>&nbsp&nbsp&nbsp
//   <td> <u>LAST NAME</u> </td>&nbsp&nbsp&nbsp
//   <td><u> EMAIL-ID</u> </td>&nbsp&nbsp&nbsp
  
//   </tr></center></h2>";
//   while($row=mysqli_fetch_array($response))
//   {
//     echo "<h4><center><tr>
//     <td>".$row['fname']."</td>&nbsp&nbsp&nbsp
//     <td>".$row['lname']."</td>&nbsp&nbsp&nbsp
//     <td>".$row['email']."</td>&nbsp&nbsp&nbsp
//     <tr></center></h4>";
//   }
//   echo "</table>";
//   # code...
