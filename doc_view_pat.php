...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top" style="background-image: url(logo.jpg);background-repeat: no-repeat;background-size: cover; ">
...
//   $path = $row['path'];
//   $id= $row['id'];
//   echo '<br><a href ="'.$path.'" > download</a>';
// }
// }
  # code...
