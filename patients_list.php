...
if ($response) {
  ...
  <tr><td colspan='2'><u>f_name</a></u> </td>
  <td colspan='2'>||||||||||________||||||||||</td>


  <td colspan='2'> <u>l_name</u> </td>
  <td colspan='2'>||||||||||________||||||||||</td>
  ...
  $querydoc = "SELECT * FROM patientinfo";
$queryldoc = mysqli_query($con,$querydoc);
while ($row = mysqli_fetch_array($queryldoc)) {
  # code...
...
<td colspan='2'></td>
 ...
 <td><form action='patients_list.php' method='POST' enctype='multipart/form-data'><input type='text' name='naam' placeholder='patient name'>
<input type='file' name='file'><input type='submit' name='button' value='submit'></form></td>
<td ><a href='doc_view_pat.php'>visit</a><td>
</tr>
    ";
  }
  }
...
$aa= "insert into user(photo) values('$file_name')";
$query=mysqli_query($con,$aa);//mysql command to insert file name with extension into the table. Use TEXT datatype for a particular column in table.
...
if(isset($_POST['show']))
{
  $bb="SELECT photo FROM user";
$result=  mysqli_query($con,$bb);
if($row=mysqli_fetch_array($result))
echo "<img src='uploads/".$row['photo']."' height = '130px' width = '130px'>";
}
//$naam = $_POST['naam'];
...
if(isset($_POST['button']))
{
  ...
  $query = "INSERT into patientinfo( name, path) values('$fname','$dat')";
  $queryl= mysqli_query($con,$query);
  // if (queryl==true) {
  //   echo "insert data";
  //   # code...
...
?>
 <!--  <a href="document.php"<?php echo $id ?>"> download</a> --> 
