...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg  fixed-top" id="mainNav" style="background-color: #003366 ; color: white">
      <a class="navbar-brand" href="index.html" style="color:white;">FORUM</a>
   ...
   <div class="panel-body" style="border-width: 200px " >
 <div class="container-fluid" style=" padding-left: 100px; padding-right: 100px; border-radius: 3px; border-color: white; padding-top:200px; padding-bottom: 200px">
<form method="POST" action="doctor_patient_forumpat.php" style="padding-left: 550px; padding-right: 550px; border-radius: 3px; border-color: white" >
          <tr><br>
