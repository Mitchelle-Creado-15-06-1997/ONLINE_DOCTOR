      ...
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          ...
          <div class="text-center">
            <a class="d-block small mt-3" href="patientlogin.php">Login Page</a>
...
function NewUser($con){
  ...
  $pass = $_POST['pass'];
  $cpass = $_POST['cpass'];
  $query = "INSERT INTO patient (fname,lname,email,pass,cpass) VALUES ('$fname','$lname','$email','$pass','$cpass')";
  ...
  if ($data==true) {
    ...
    // }
  if ($pass!=$cpass) {
    $query= "UPDATE patient SET pass ='$cpass' WHERE email='$email' ";
    //echo $query;
    $data = mysqli_query($con,$query) or die (mysqli_error($con));
    if ($data) {
...
function Signup($con){
  ...
  {
    //echo "signup";
    $query = mysqli_query($con,"SELECT * FROM patient WHERE email ='$_POST[email]' AND pass = '$_POST[pass]'")or die (mysqli_error($con));
