...
<center><img class="avatar img-circle"  src="img/logo.jpg" style="border-radius: 100%; height: 200px; width: 200px"></center>
  ...
  <div class="col-md-3">
      ...
      <form action="profile.php" method="POST" enctype="multipart/form-data">
        ...
        upload: <input type="file" name="file" id="file" size="80"><br><br>
      ...
      <div class="col-md-9 personal-info">
        ...
        <h3 style="padding-left: 300px">Personal info</h3>
       ...
       <div><center><br>FIRST DELETE YOUR PREVIOUS PROFILE<BR><input id="button" type="submit" name="delete" value="delete"></center></div>
            ...
            <div class="form-group">
              ...
              <input type="name" class="form-control" aria-describedby="emailHelp" placeholder="Enter specifications" name="spec">
            </div>
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
...
function NewUser($con){
  ...
  $query = "INSERT INTO docprofile (name,spec,age) VALUES ('$name','$spec','$age')";
...
//     move_uploaded_file($_FILES["file"]["tmp_name"], "C:\xampp\htdocs\doc_pat\uploads" .$_FILES["file"]["name"]);
...
if(isset($_POST['button']))
{
  ...
  $query = "INSERT into documents( name, path) values('$fname','$dat')";
