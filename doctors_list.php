...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg  fixed-top" id="mainNav" style="background-color: #003366 ; color: white">
      <a class="navbar-brand" href="main.html" style="color:white;">DOCTOR LIST</a>
 ...
 <?php
require('config.php');
$query = "SELECT fname,lname, email, spec from doctor";
...
if ($response) {
  ...
  <td colspan='2'><u> EAMIL</u> </td>
  <td colspan='2'>______________________</td>

  <td colspan='2'><u> SPECIFICATIONS</u> </td>
  <td colspan='2'></td>
